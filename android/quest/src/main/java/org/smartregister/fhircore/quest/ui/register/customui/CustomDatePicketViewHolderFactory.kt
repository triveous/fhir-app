...
internal object CustomDatePickerViewHolderFactory :
  ...
  override fun getQuestionnaireItemViewHolderDelegate() =
    object : QuestionnaireItemViewHolderDelegate {
      ...
      class DatePatternTextWatcher(private val dateFormatSeparator: Char?) : TextWatcher {
  ...
  fun matcher(questionnaireItemComponent: Questionnaire.QuestionnaireItemComponent): Boolean {
    return  questionnaireItemComponent.type == Questionnaire.QuestionnaireItemType.DATE
  }
}
